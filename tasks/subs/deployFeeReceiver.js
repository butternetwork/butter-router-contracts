...
module.exports = async (taskArgs, hre) => {
    ...
    let feeReceiver = await create(hre,deployer,"FeeReceiver",["address[]", "uint256[]", "address"],[payees, shares, deployer],salt)
    ...
    await verify(feeReceiver, [payees, shares, deployer], "contracts/FeeReceiver.sol:FeeReceiver", hre.network.config.chainId, true);
